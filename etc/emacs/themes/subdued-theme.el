...
(custom-theme-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "#006400")))) ; dark green
 '(font-lock-comment-delimiter-face ((t (:foreground "#006400")))) ; dark green
 ...
 '(font-lock-constant-face ((t (:foreground "#855c1b")))) ; med-dark chocolate
